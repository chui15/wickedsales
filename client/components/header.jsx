...
class Header extends React.Component {
  ...
  render() {
    return (
      <header>
        <div className="row">
          <div className="col-3 md-5 ml-5 mr-5 align-self-start header-definition">許願 (xu3 yuan4): to make a wish / to make a vow / to promise a reward.</div>
          <h1 className="col-4 md-3 ml-5 mr-3 align-self-start header-title" onClick={this.switchView}>許願 Shop.</h1>
