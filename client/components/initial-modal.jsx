    ...
    return (
      <div className={showModalBack}>
        <div className={showModal}>
          ...
          <p className="modal-disclaimer">*Mobile and iPad users: this application is currently best viewed on landscape orientation.  If currently on portrait mode, please rotate the device to landscape orientation to proceed.</p>
          <span>
